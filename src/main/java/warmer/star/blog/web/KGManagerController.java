...
public class KGManagerController extends BaseController {
	...
	@Autowired
	private KGGraphService graphService;
	@Autowired
	...
	public KGR<GraphPageRecord<Map<String, Object>>> getgraph(GraphQuery queryItem) {
		KGR<GraphPageRecord<Map<String, Object>>> result = new KGR<GraphPageRecord<Map<String, Object>>>();
	...
	public KGR<HashMap<String, Object>> getDomainGraph(GraphQuery query) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		try {
	...
	public KGR<HashMap<String, Object>> getcypherresult(String cypher) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		String error="";
		try {
	...
	public KGR<String> getrelationnodecount(String domain, long nodeid) {
		KGR<String> result = new KGR<String>();
		try {
			long totalcount = 0;
			if (!StringUtil.isBlank(domain)) {
				totalcount = graphService.getrelationnodecount(domain, nodeid);
				result.code = 200;
	...
	public KGR<String> createdomain(String domain) {
		KGR<String> result = new KGR<String>();
		try {
			if (!StringUtil.isBlank(domain)) {
				...
				if (domainItem.size() > 0) {
					...
					graphService.createdomain(domain);// 保存到图数据
					result.code = 200;
				}
			}
		} catch (Exception e) {
	...
	public KGR<HashMap<String, Object>> getmorerelationnode(String domain, String nodeid) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		try {
			if (!StringUtil.isBlank(domain)) {
				HashMap<String, Object> graphModel = graphService.getmorerelationnode(domain, nodeid);
				if (graphModel != null) {
					result.code = 200;
	...
	public KGR<HashMap<String, Object>> updatenodename(String domain, String nodeid, String nodename) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		HashMap<String, Object> graphNodeList = new HashMap<String, Object>();
		try {
			if (!StringUtil.isBlank(domain)) {
				graphNodeList = graphService.updatenodename(domain, nodeid, nodename);
	...
	public KGR<String> updateCorrdOfNode(String domain, String uuid, Double fx, Double fy) {
		KGR<String> result = new KGR<String>();
		try {
			graphService.updateCorrdOfNode(domain, uuid, fx, fy);
			result.code = 200;
		} catch (Exception e) {
			e.printStackTrace();
			result.code = 500;
	...
	public KGR<HashMap<String, Object>> createnode(QAEntityItem entity, HttpServletRequest request,
												 HttpServletResponse response) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		HashMap<String, Object> graphNode = new HashMap<String, Object>();
		try {
			String domain = request.getParameter("domain");
			graphNode=graphService.createnode(domain, entity);
	...
	public KGR<HashMap<String, Object>> batchcreatenode(String domain, String sourcename, String[] targetnames,
			String relation) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		HashMap<String, Object> rss = new HashMap<String, Object>();
		try {
			rss= graphService.batchcreatenode(domain, sourcename, relation, targetnames);
			result.code = 200;
			result.setData(rss);
			return result;
		} catch (Exception e) {
	...
	public KGR<HashMap<String, Object>> batchcreatechildnode(String domain, String sourceid, Integer entitytype,
			String[] targetnames, String relation) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		HashMap<String, Object> rss = new HashMap<String, Object>();
		try {
			rss= graphService.batchcreatechildnode(domain, sourceid, entitytype, targetnames, relation);
			result.code = 200;
			result.setData(rss);
			return result;
	...
	public KGR<List<HashMap<String, Object>>> batchcreatesamenode(String domain, Integer entitytype,
			String[] sourcenames) {
		KGR<List<HashMap<String, Object>>> result = new KGR<List<HashMap<String, Object>>>();
		List<HashMap<String, Object>> rss = new ArrayList<HashMap<String, Object>>();
		try {
			rss=graphService.batchcreatesamenode(domain, entitytype, sourcenames);
			result.code = 200;
			result.setData(rss);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public KGR<HashMap<String, Object>> createlink(String domain, long sourceid, long targetid, String ship) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		try {
			HashMap<String, Object> cypherResult = graphService.createlink(domain, sourceid, targetid, ship);
			result.code = 200;
	...
	public KGR<HashMap<String, Object>> updatelink(String domain, long shipid, String shipname) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		try {
			HashMap<String, Object> cypherResult = graphService.updatelink(domain, shipid, shipname);
			result.code = 200;
			result.setData(cypherResult);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public KGR<List<HashMap<String, Object>>> deletenode(String domain, long nodeid) {
		KGR<List<HashMap<String, Object>>> result = new KGR<List<HashMap<String, Object>>>();
		try {
			List<HashMap<String, Object>> rList = graphService.deletenode(domain, nodeid);
			result.code = 200;
	...
	public KGR<List<HashMap<String, Object>>> deletedomain(Integer domainid, String domain) {
		KGR<List<HashMap<String, Object>>> result = new KGR<List<HashMap<String, Object>>>();
		try {
			kgservice.deleteDomain(domainid);
			graphService.deleteKGdomain(domain);
			result.code = 200;
			return result;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public KGR<HashMap<String, Object>> deletelink(String domain, long shipid) {
		KGR<HashMap<String, Object>> result = new KGR<HashMap<String, Object>>();
		try {
			graphService.deletelink(domain, shipid);
			result.code = 200;
			return result;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public JSONObject importgraph(@RequestParam(value = "file", required = true) MultipartFile file,
		...
		try {
			...
			graphService.batchInsertByCSV(label, csvUrl, 0);
			res.put("code", 200);
	...
	public KGR<List<Map<String, Object>>> getNodeImagelist(int domainid, int nodeid) {
		KGR<List<Map<String, Object>>> result = new KGR<List<Map<String, Object>>>();
		try {
	...
	public KGR<Map<String, Object>> getNodeContent(int domainid, int nodeid) {
		KGR<Map<String, Object>> result = new KGR<Map<String, Object>>();
		try {
	...
	public KGR<Map<String, Object>> getNodeDetail(int domainid, int nodeid) {
		KGR<Map<String, Object>> result = new KGR<Map<String, Object>>();
		try {
	...
	public KGR<String> saveNodeImage(@RequestBody Map<String, Object> params) {
		KGR<String> result = new KGR<String>();
		try {
			String username = "tc";
			...
			if (domainList != null && domainList.size() > 0) {
				...
				if (submitItemList != null && submitItemList.size() > 0) {
					...
					graphService.updateNodeFileStatus(domainName, Long.parseLong(nodeid), 1);
					result.code = 200;
					result.setMsg("操作成功");
				} else {
					graphService.updateNodeFileStatus(domainName, Long.parseLong(nodeid), 0);
					result.code = 200;
					result.setMsg("操作成功");
				}
			}
	...
	public KGR<String> savenodecontent(@RequestBody Map<String, Object> params) {
		KGR<String> result = new KGR<String>();
		try {
			String username = "tc";
			int domainid = (int) params.get("domainid");
